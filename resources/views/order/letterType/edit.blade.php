...
@section('content')
<h4>Edit Data Klasifikasi Surat</h4>
    <form action="{{ route('order.letterType.update', $letterTypes['id']) }}" method="POST" class="card p-5">
        @csrf
        @method('PATCH')
        ...
        <div class="mb-3 row">
            <label for="name_type" class="col-sm-2 col-form-label">Klarifikasi Surat :</label>
            <div class="col-sm-10">
