...
@section('content')
    ...
    <h3>Data Guru</h3>
    <div class="col-md-6">
        <form action="{{ route('order.guru.index') }}" method="GET">
            <div class="input-group">
                <input type="text" name="name" id="name" value="{{ request('name') }}" class="form-control">
                <button type="submit" class="btn btn-info">Search</button>
                @if(request('name'))
                    <a href="{{ route('order.guru.index') }}" class="btn btn-secondary">Clear</a>
                @endif
            </div>
        </form>
    </div>
    <div class="justify-content-end d-flex">
        <a href="{{ route('order.guru.create') }}" class="btn btn-primary" style="margin-top: 1em">Tambah</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex justify-content-center">
                    <a href="{{ route('order.guru.edit', $item['id']) }}" class="btn btn-primary me-3">Edit</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('order.guru.destroy', $item['id']) }}" method="POST">
                            @csrf
                            @method('DELETE')
