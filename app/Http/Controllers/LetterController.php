...
class LetterController extends Controller
{
    ...
    public function index()
    {
        ...
        $letters = Letter::all();
        return view('order.letter.index', compact('letters'));
    }
    ...
    {
        $letters = Letter::all();
        return view("order.letter.create", compact('letters'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('order.letter.index')->with('success', 'Berhasil menambahkan data!');
    }
    ...
    public function edit(Letter $letter, $id)
    {
        ...
        return view('order.letter.edit', compact('letters'));
    }
